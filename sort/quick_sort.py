...
#Quick Sort is a recursive method(method that calls itself),and implements divide-and-conquer sorting algorithm, thats very efficent for large data sets
#performance depends largly on pivot selection 
