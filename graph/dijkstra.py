...
2. Mark all nodes as unvisited. Set initial node as current. 3. For
current node, consider all its unvisited neighbors and calculate their
...
if __name__ == '__main__':
   ...
   # print(shortest_path(g, 1, 5))
    print(dijkstra(g, 1))
  #  print(shortest_path(g, 5, 1)) == [5, 6, 3, 1]
   # print(shortest_path(g, 2, 5)) == [2, 3, 6, 5]
