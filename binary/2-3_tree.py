...
#balanced searched tree: all leaf nodes are at the same level
#Each parent node can have: 1 value and 2 children OR 2 values and 3 children
#program output
#Root : [16] #1 value 
#[16] : [4, 13] #and 2 children
#[4, 13] : [1] #2 values and 3 children
#[4, 13] : [5, 7] #2 values and 3 children
#[4, 13] : [15] #2 values and 3 children
#[16] : [20, 24] #1 value and 2 children
#[20, 24] : [17, 19]#2 values and 3 children
#[20, 24] : [22]#2 values and 3 children
#[20, 24] : [29]#2 values and 3 children
#4, 13 #2 values
# <4, 4-13, >13  #3 children
#[1], [5, 7], [15] #3 nodes, with a max of 2 items in each 
